...
check "MetaTags output exists" test -f src/Public_/Output/MetaTags.php
...
check "CredentialBadge has shortcode registration" grep -q "register_shortcode" src/Public_/Badges/CredentialBadge.php
